            ...
            <div className='contact'>
                ...
                <p className='address'>
                    ...
                    <span className='address-text'>
                        Rua do Ginásio, Maputo, Mozambique ● Rua da Academia, Matola, Mozambique
                    </span>
                </p>
                <p className='phone'> 
                    <span className='top-bar-icon'><FiPhone size={17} /></span>
                    <span className='phone-number'> +258 82 123 000 / 84 123 0000 </span>
                </p>
            </div>
        </div>
            ...
            <div className='navbar-container'>
                ...
                <div className='features'>
                    ...
                    <div className="dropdown dropdown-hover">
                        ...
                        <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
                            <li><Link>Maputo</Link></li>
                            <li><Link>Matola</Link></li>
                        </ul>
                    </div>
                    {/* About */}
                    <div className="dropdown dropdown-hover">
